...
const PropertySchema = new mongoose.Schema(
  {
    ...
    propertyType: { type: String, enum: ['pg', 'guest', 'plot'], required: true },
    ...
    pgDetails: {
      ...
      sharingPricing: {
        singleRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        doubleRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        tripleRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
      },
      groupPricing: {
        twoPersons:   { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        threePersons: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        fourPersons:  { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
      },
      facilities:     [String],
    ...
    guestRoomDetails: {
      ...
      pricing: {
        singleRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        doubleRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
        familyRoom: { price: { type: Number, default: 0 }, deposit: { type: Number, default: 0 } },
      },
      facilities:     [String],
      commonKitchen:  { type: Boolean, default: false },
      privateKitchen: { type: Boolean, default: false },
